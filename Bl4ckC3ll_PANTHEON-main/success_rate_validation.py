...
try:
    from enhanced_scanning import get_current_success_rate, run_enhanced_scanning
    from enhanced_tool_manager import check_tool_availability, get_tool_coverage_report
